...
//   if (path.length == 1) path = fileName.split("/");
//   if (path.length > 1) {
//     for (let i = 0; i < path.length - 1; i++) {
//       folder = folder.find(
//         (file) => file.name.toLowerCase() == path[i].toLowerCase()
//       ).files;
//     }
//     actualFileName = path[path.length - 1];
//   }
//   let file = folder.find(
//     (file) => file.name.toLowerCase() == actualFileName.toLowerCase()
//   );
//   if (file != null) return file;
//   // try another file with same name but different extension
//   return folder.find((file) =>
//     file.name.match(/\.[a-zA-Z0-9]+/) != null &&
//     actualFileName.match(/\.[a-zA-Z0-9]+/) != null
//       ? file.name
//           .substring(
//             0,
//             file.name.length - file.name.match(/\.[a-zA-Z0-9]+/)[0].length
//           )
//           .toLowerCase() ==
//         actualFileName
//           .substring(
//             0,
//             actualFileName.length -
//               actualFileName.match(/\.[a-zA-Z0-9]+/)[0].length
//           )
//           .toLowerCase()
//       : false
//   );
...
//   if (file != null) return file;
//   // try another file with same name but different extension
//   return Object.keys(folder).find((filename) =>
//     filename.match(/\.[a-zA-Z0-9]+/) != null &&
//     actualFileName.match(/\.[a-zA-Z0-9]+/) != null
//       ? file.name
//           .substring(
//             0,
//             filename.length - filename.match(/\.[a-zA-Z0-9]+/)[0].length
//           )
//           .toLowerCase() ==
//         actualFileName
//           .substring(
...
//   return new Promise((resolve, reject) => {
//     fflate.unzip(new Uint8Array(zip), (err, unzipped) =>
//       !err ? resolve(unzipped) : reject(err)
//     );
//   });
// };
